...
function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-800 p-10">
      ...
      <h2 className="text-2xl text-white mb-6">Admin Dashboard</h2>

      <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 border border-white/20 mb-6">
        <div className="flex items-center gap-3 text-white">
          <div className="w-10 h-10 bg-yellow-500 rounded-full flex items-center justify-center font-semibold">
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 border border-white/20">
        <div className="flex flex-col md:flex-row gap-4">
          <button
            ...
            className="flex-1 bg-yellow-500 hover:bg-yellow-600 p-3 rounded-lg text-white transition"
          >
            Manage Questions
          </button>
